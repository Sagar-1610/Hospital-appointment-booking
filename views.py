...
def Appointment(request):
    ...
    if request.method=="POST":
        ...
        message= '''<p>Dear Mr/Ms.<b>{}</b>,<br>I would like to confirm your appointment with Thomas on Tomorrow, at 6:00 PM.Your appointment number is <b>{}</b> If you have any questions or want to request changes, please contact me.
                    <br>Regards,
